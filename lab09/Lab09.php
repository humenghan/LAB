...
<body>
   ...
   //              </a>
			// </li>
          foreach ($images as $keys => $value){
              echo"<li><a href='detail.php?id=".$images[$keys]["id"]."'class='img-responsive'><img src='images/square/".$images[$keys]["path"]." 'alt=".$images[$keys]["title"]."'>
              <div class=\"caption\">
               		<div class=\"blur\">
                		</div>
                		<div class=\"caption-text\">
                			<h1>".$images[$keys]["title"]."</h1>
              		</div>
               	</div>
               </a>";
